  ...
  (0, (_createClass2 || _load_createClass()).default)(AndroidBuilder, [{
    ...
    value: function () {
      var _ref = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee(options) {
        var buildOptions, sdkVersion, publishedExpIds;
        return (_regenerator || _load_regenerator()).default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                sdkVersion = _context.sent;
                _context.next = 6;
                return this.checkForBuildInProgress((0, (_extends2 || _load_extends()).default)({
                  platform: ANDROID,
              ...
              case 15:
                ...
                _context.next = 19;
                return this.checkStatusBeforeBuild({ platform: ANDROID, sdkVersion: sdkVersion });
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 10:
                ...
                _context6.next = 14;
                return (_utils || _load_utils()).checkIfSdkIsSupported(sdkVersion, ANDROID);

              case 14:
                return _context6.abrupt('return', sdkVersion);
