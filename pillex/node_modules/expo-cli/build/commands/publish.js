...
var action = exports.action = function () {
  var _ref = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee(projectDir) {
    ...
    var channelRe, status, startedOurOwn, startOpts, recipient, _ref2, sdkVersion, buildStatus, result, url;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 24:
            ...
            if (buildStatus.userHasBuiltExperienceBefore && !buildStatus.userHasBuiltAppBefore && !options.duringBuild) {
