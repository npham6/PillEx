...
var IOSUploader = function (_BaseUploader) {
  ...
  (0, (_createClass2 || _load_createClass()).default)(IOSUploader, [{
    ...
    value: function _ensureExperienceIsValid(exp) {
      if (!(0, (_has || _load_has()).default)(exp, 'ios.bundleIdentifier')) {
    ...
    value: function () {
      var _ref = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee() {
        var appleIdCrentials, appleTeamId, appName, otherOptions;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                _context.next = 5;
                return this._getAppleTeamId();

              case 5:
                appleTeamId = _context.sent;
                _context.next = 8;
                return this._getAppName();

              case 8:
                appName = _context.sent;
                otherOptions = (0, (_pick || _load_pick()).default)(this.options, ['language', 'sku']);
    ...
    value: function () {
      var _ref2 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee2() {
        var publicUrl, _ref3, _ref3$args, username, experienceName, bundleIdentifier, _ref4, teamId;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 10:
                ...
                _context2.next = 17;
                return (_xdl || _load_xdl()).Credentials.getCredentialsForPlatform({
                  username: username,
              ...
              case 17:
                ...
                teamId = _ref4.teamId;
                return _context2.abrupt('return', teamId);
      ...
      function _getAppleTeamId() {
        return _ref2.apply(this, arguments);
      }

      return _getAppleTeamId;
    }()
  }, {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                result = (0, (_pick || _load_pick()).default)(this.options, appleCredsKeys);
                ...
                credsPresent = (0, (_intersection || _load_intersection()).default)((0, (_keys || _load_keys()).default)(result), appleCredsKeys);
                ...
                questions = APPLE_CREDS_QUESTIONS.filter(function (_ref6) {
                  var name = _ref6.name;
              ...
              case 9:
                ...
                return _context3.abrupt('return', (0, (_extends2 || _load_extends()).default)({}, result, answers));
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 2:
                ...
                return _context5.abrupt('return', appName);
    ...
    value: function () {
      var _ref10 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee6(platformData, buildPath) {
        var fastlane, appleId, appleIdPassword, appName, language, appleTeamId, bundleIdentifier, appleCreds;
        return (_regenerator || _load_regenerator()).default.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                fastlane = this.fastlane;
                appleId = platformData.appleId, appleIdPassword = platformData.appleIdPassword, appName = platformData.appName, language = platformData.language, appleTeamId = platformData.appleTeamId;
                bundleIdentifier = this._exp.ios.bundleIdentifier;
                appleCreds = { appleId: appleId, appleIdPassword: appleIdPassword, appleTeamId: appleTeamId };


                (0, (_log || _load_log()).default)('Ensuring the app exists on App Store Connect, this may take a while...');
                _context6.next = 7;
                return (0, (_utils || _load_utils()).runFastlaneAsync)(fastlane.appProduce, [bundleIdentifier, appName, appleId, language], appleCreds);

              case 7:

                (0, (_log || _load_log()).default)('Uploading the app to Testflight, hold tight...');
                _context6.next = 10;
                return (0, (_utils || _load_utils()).runFastlaneAsync)(fastlane.pilotUpload, [buildPath, appleId], appleCreds, true);
