...
let extractTemplateApp = exports.extractTemplateApp = (() => {
  var _ref2 = _asyncToGenerator(function* (templateSpec, projectRoot, packageManager = 'npm', workflow = 'managed', initialConfig = {}) {
    ...
    let appJson = (0, (_merge || _load_merge()).default)((yield appFile.readAsync()), { expo: initialConfig });
    ...
    if (workflow === 'advanced') {
      (_Logger || _load_Logger()).default.global.info('Installing ExpoKit...');
      yield (_Detach || _load_Detach()).detachAsync(projectRoot, { packageManager });
    } else {
...
let initGitRepo = (() => {
  ...
  return function initGitRepo(_x4) {
...
let installDependencies = (() => {
  ...
  return function installDependencies(_x5, _x6) {
...
function _load_Detach() {
  return _Detach = _interopRequireWildcard(require('./detach/Detach'));
}
