...
exports.backupExistingAndroidCredentials = exports.getExistingPushKeys = exports.getExistingDistCerts = exports.removeCredentialsForPlatform = exports.updateCredentialsForPlatform = exports.getCredentialsForPlatform = exports.getEncryptedCredentialsForPlatformAsync = exports.credentialsExistForPlatformAsync = undefined;
...
let getExistingDistCerts = exports.getExistingDistCerts = (() => {
  ...
  return function getExistingDistCerts(_x12, _x13) {
    return _ref7.apply(this, arguments);
  };
})();

let getExistingPushKeys = exports.getExistingPushKeys = (() => {
  var _ref8 = _asyncToGenerator(function* (username, appleTeamId) {
  ...
  return function getExistingPushKeys(_x14, _x15) {
    return _ref8.apply(this, arguments);
  };
})();

let getExistingUserCredentials = (() => {
  var _ref9 = _asyncToGenerator(function* (username, appleTeamId, type) {
    ...
    if (err) {
      ...
      return certs.map(function (_ref10) {
        let { usedByApps, userCredentialsId } = _ref10,
            rest = _objectWithoutProperties(_ref10, ['usedByApps', 'userCredentialsId']);
  ...
  return function getExistingUserCredentials(_x16, _x17, _x18) {
...
let backupExistingAndroidCredentials = exports.backupExistingAndroidCredentials = (() => {
  var _ref11 = _asyncToGenerator(function* ({
    ...
    yield (_fsExtra || _load_fsExtra()).default.writeFile(outputPath, storeBuf);
    if (logSecrets) {
  ...
  return function backupExistingAndroidCredentials(_x19) {
